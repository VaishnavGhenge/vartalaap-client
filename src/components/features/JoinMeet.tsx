...
export default function JoinMeet() {
    ...
    return (
        <main className="call-stage relative flex flex-1 overflow-y-auto">
            <div
                className="w-full max-w-5xl mx-auto px-4 py-6 sm:py-10 lg:py-16
            ...
            >
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 w-full">
                    ...
                    <div className="lg:col-span-3">
                        <div
                            className={`tile-in app-panel relative w-full overflow-hidden rounded-2xl${speaking ? " speaking-ring" : ""}`}
                        ...
                        {(audioInputs.length > 0 || videoInputs.length > 0 || showSpeaker) && (
                            <Collapsible label="Audio & video settings" storageKey="join-devices-open" className="mt-3">
                    ...
                    <div className="lg:col-span-2 flex flex-col justify-center">
                        <div className="app-panel rounded-2xl p-5 sm:p-6">
                            <h1 className="font-display text-3xl">Ready to join?</h1>
                            <p className="mb-5 mt-2 text-sm text-[hsl(var(--muted-foreground))]">
                                Make yourself comfortable. Check your devices, then join the conversation.
                            </p>
                            {deviceError && (
                                <DeviceErrorNotice
                                    message={deviceError}
                            ...
                            <p role="status" className="mb-4 text-xs text-[hsl(var(--muted-foreground))]">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    onClick={handleShare}
                                    aria-label={
                                        copied ? "Link copied" : canShare ? "Share meeting link" : "Copy meeting link"
                                    }
                            ...
                            {!statusChecked ? (
                                ...
                                <div
                                    role="status"
                                    className="mt-6 flex items-center justify-center gap-3 py-6 text-sm text-[hsl(var(--muted-foreground))]"
                                >
                                    <Loader2 className="size-4 animate-spin" aria-hidden="true" />
                                    Checking your meeting room…
                                </div>
                                        ...
                                        <div className="flex items-center gap-3 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--surface-2))] px-3 py-2.5">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <p className="text-xs text-[hsl(var(--muted-foreground))]">
                                                    Joining with your Sessionly profile
                                                </p>
                                            </div>
                                        </div>
                                    ) : (
...
function SessionExpiredCard({ meetCode, onContinueAsGuest }: { meetCode: string; onContinueAsGuest: () => void }) {
    return (
        <div className="mt-4 flex flex-col gap-3">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 text-sm leading-5 text-[hsl(var(--muted-foreground))]">
                            Sign in again to join with your profile, or continue as a guest — the host will be asked to
                            let you in.
                        </p>
                    </div>
                </div>
